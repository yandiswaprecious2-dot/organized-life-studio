...
const essentialTemplates = [
  // Budgeting
  { id: 1, name: "Monthly Budget Planner Minimal", description: "Clean, distraction-free layout for simple monthly budgeting.", price: 4, image: "/placeholder.svg", category: "Budgeting", slug: "monthly-budget-planner-minimal" },
  { id: 2, name: "Monthly Budget Planner Neutral", description: "Elegant neutral tones for a calm budgeting experience.", price: 4, image: "/placeholder.svg", category: "Budgeting", slug: "monthly-budget-planner-neutral" },
  { id: 3, name: "Expense Tracker Classic", description: "Traditional expense tracking with categories and summaries.", price: 4, image: "/placeholder.svg", category: "Budgeting", slug: "expense-tracker-classic" },
          ...
          <div className="container mx-auto px-6">
            ...
            >
              {essentialTemplates.map((template) => {
                const slug = template.slug || template.name.toLowerCase().replace(/\s+/g, '-').replace(/&/g, 'and');
